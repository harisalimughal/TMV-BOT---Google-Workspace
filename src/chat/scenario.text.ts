/**
 * Verbatim legal/confirmation copy for the scenario forms, reproduced exactly from
 * the client's mockups. Never paraphrase these — edit only if the client supplies
 * revised wording.
 */

export const CHECK_IN_SIGNATURE_TEXT =
  "By signing this document, you confirm that, All items listed have been checked in and stored.";

export const CHECK_OUT_SIGNATURE_TEXT =
...
export const LIABILITY_REPORT_SIGNATURE_TEXT =
