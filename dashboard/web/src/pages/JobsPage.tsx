...
export function JobsPage() {
  ...
  return (
    <div className="space-y-4 max-w-full">
      ...
      <div className="bg-paper p-3.5 rounded-xl border border-line flex flex-wrap items-center justify-between gap-3 shadow-card">
      ...
      {filterDrawerOpen && (
        <div className="p-4 bg-paper rounded-xl border border-line flex flex-wrap items-center gap-4 text-xs shadow-card">
      ...
      {viewMode === "table" && (
        <div className="bg-paper rounded-xl border border-line shadow-card overflow-hidden">
            ...
            data?.items.map((job: NormalizedJob) => {
              ...
              return (
                <div
                  key={job.jobId}
                  onClick={() => setDrawerJob(job)}
                  className="p-4 bg-paper rounded-xl border border-line shadow-card hover:border-line-strong cursor-pointer transition space-y-3"
                >
                  <div className="flex items-center justify-between">
