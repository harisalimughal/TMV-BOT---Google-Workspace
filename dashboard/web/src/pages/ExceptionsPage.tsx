...
export function ExceptionsPage({ onOpenJob }: Props) {
  ...
  if (error || !data) {
    return (
      <div className="p-8 text-center text-status-red bg-paper rounded-xl border border-line shadow-card">
    ...
    <div className="space-y-6 max-w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div
          ...
          className={`p-4 rounded-xl border transition cursor-pointer shadow-card flex items-center justify-between ${
