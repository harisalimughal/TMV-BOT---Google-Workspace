...
export function OverviewPage({ onSelectSection }: Props) {
  ...
  return (
    <div className="space-y-6 max-w-full">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 bg-paper p-5 rounded-xl border border-line shadow-card">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Gross Invoiced */}
        <div className="p-5 bg-paper rounded-xl border border-line shadow-card hover:border-line-strong transition flex flex-col justify-between group">
          <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-4 bg-paper rounded-xl border border-line shadow-card flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-6 bg-paper rounded-xl border border-line shadow-card">
