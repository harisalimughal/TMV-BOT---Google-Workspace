...
export function DateRangePicker({ from, to, onChange }: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 text-xs">
      <div className="flex items-center gap-1 bg-surface-2 p-1 rounded-lg border border-line">
        <button
          ...
          className={`px-2.5 py-1 rounded-md font-medium transition ${
            !from && !to ? "bg-paper text-tmv-blue shadow-sm font-bold" : "text-muted hover:text-ink"
          }`}
        >
          All Time
        </button>
        <button
          ...
          className="px-2.5 py-1 rounded-md font-medium text-muted hover:text-ink transition"
        >
          Today
        </button>
        <button
      ...
      <div className="flex items-center gap-1 bg-paper px-2 py-1 rounded-lg border border-line text-ink">
