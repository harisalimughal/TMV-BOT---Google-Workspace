...
export function SearchFilterBar({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 p-4 bg-paper rounded-xl border border-line mb-6 shadow-paper">
      <div className="flex flex-wrap items-center gap-3 flex-1 min-w-[280px]">
        ...
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-8 py-2 bg-surface rounded-lg text-xs border border-line focus:bg-paper focus:border-tmv-blue focus:outline-none transition"
          />
          {search && (
            <button
        ...
        <select
          ...
          className="px-3 py-2 bg-surface rounded-lg text-xs border border-line text-ink-2 font-medium focus:outline-none"
        >
        ...
        {hasActiveFilters && onResetFilters && (
          <button
            ...
            className="inline-flex items-center gap-1 text-xs text-status-red font-medium hover:underline ml-1"
          >
