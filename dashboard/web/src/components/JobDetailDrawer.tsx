    ...
    <div className="fixed inset-0 z-50 overflow-hidden bg-ink/40 backdrop-blur-xs flex justify-end">
      ...
      <div className="w-full max-w-2xl bg-paper border-l border-line shadow-pop flex flex-col h-full overflow-hidden animate-slide-in-right">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-xs text-ink">
          {/* Quick Metrics Bar */}
          <div className="grid grid-cols-3 gap-3 p-3.5 rounded-xl bg-surface border border-line">
            <div>
          ...
          {/* Route & Postcodes */}
          <div className="p-4 rounded-xl border border-line bg-paper space-y-3 shadow-card">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl border border-line bg-paper space-y-2 shadow-card">
            ...
            <div className="p-4 rounded-xl border border-line bg-paper flex flex-col justify-between shadow-card">
