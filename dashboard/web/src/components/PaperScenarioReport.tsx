      ...
      <div className="print-page-container">
        ...
        {photoUrl && (
          <div className="flex flex-col mb-6">
            ...
            <div className="flex items-center justify-center border border-line rounded-xl p-2 shadow-sm bg-[#FAFAFA] h-[45vh]">
              <img 
        ...
        <div className="flex gap-6">
          <div className="flex-1 bg-[#F7F7F7] rounded-xl border border-line p-6 shadow-sm">
          ...
          <div className="flex-1">
            ...
            <div className="w-full h-[120px] border border-line rounded-xl bg-white p-4 shadow-sm flex items-center justify-center">
              {signature ? (
